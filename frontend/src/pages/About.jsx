  ...
  const values = [
    {
      ...
      description:
        "We are dedicated to making a real impact through sustainable and efficient solutions.",
    },
    {
      icon: Lightbulb,
      title: "Innovation First",
      description:
        "Constantly exploring new possibilities to advance modern agriculture and technology.",
    },
    {
      icon: Users,
      title: "Team Collaboration",
      description:
        "We thrive through teamwork, empowering everyone to achieve excellence together.",
    },
    {
      icon: Heart,
      title: "Customer Focused",
      description:
        "Our clients are our top priority — we aim to exceed expectations every single time.",
    },
  ];

  const team = [
    { name: "Harshit Raj", role: "CEO", image: team1 },
    { name: "Sachin Kumar", role: "Marketing-head", image: team2 },
    { name: "Alok Kumar", role: "Senior Developer", image: team3 },
    { name: "Gaurav Tiwari", role: "Design Head", image: team4 },
  ];
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto animate-fade-in py-20">
          ...
          <p className="text-xl md:text-2xl text-green-50/95 leading-relaxed max-w-3xl mx-auto">
            We are a passionate team committed to innovation, excellence, and
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center animate-fade-in">
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Founded with a vision to transform agriculture through
                technology, we started small and evolved into a trusted partner
                for sustainable farming solutions. Our focus is on creating
                intelligent systems that enhance soil health, optimize fertilizer
                use, and improve crop yield.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Every day, we work tirelessly to deliver innovative solutions that
                empower farmers and agritech companies to achieve their goals and
      ...
      <section className="py-24 px-6 bg-gradient-to-b from-green-100/20 via-background to-green-100/20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20 animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Experienced professionals dedicated to driving innovation and success.
            </p>
          </div>
